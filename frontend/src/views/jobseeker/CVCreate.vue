...
const createCV = async () => {
  ...
  try {
    const response = await api.post('/jobseeker/cvs', cvData.value)
    success.value = true
    ...
    error.value = err.response?.data?.message || 'Tạo CV thất bại. Vui lòng thử lại.'
  } finally {
  ...
  <div class="cv-create">
    <div class="container">
      <div class="cv-header">
        ...
        <p>Điền thông tin chi tiết để tạo CV ấn tượng</p>
      </div>

      <form @submit.prevent="createCV" class="cv-form">
        <!-- Basic Information -->
        ...
        <div v-if="success" class="success-message">
          Tạo CV thành công! Đang chuyển hướng...
        </div>

        <!-- Form Actions -->
        <div class="form-actions">
          <button type="submit" :disabled="isLoading" class="btn btn-primary">
            {{ isLoading ? 'Đang tạo...' : 'Tạo CV' }}
          </button>
