...
• Team building và các hoạt động nội bộ thường xuyên`,
    ...
    companyInfo: {
      ...
      description: "TechCorp Vietnam là một công ty công nghệ hàng đầu chuyên phát triển các giải pháp phần mềm cho doanh nghiệp. Với hơn 8 năm kinh nghiệm, chúng tôi đã phục vụ hơn 200+ khách hàng trong và ngoài nước.",
      established: "2016",
  ...
  const ApplyModal = () => (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg p-6 max-w-md w-full">
        <h3 className="font-semibold text-gray-900 mb-4">Ứng tuyển: {job.title}</h3>
        <p className="text-gray-600 mb-6">
          Bạn có chắc chắn muốn ứng tuyển cho vị trí này không? Hệ thống sẽ chuyển bạn đến trang tạo CV.
        </p>
        ...
        <div className="mb-8">
          <BreadcrumbTabActive 
            items={[
              ...
              { name: "Việc làm", onClick: () => navigate?.("jobs") },
              { name: job.title }
            ]} 
          />
        </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6 sticky top-24">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900">{job.companyInfo.established}</p>
                </div>
                <div>
                ...
                <div className="pt-4 border-t border-gray-200">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center text-sm text-gray-600">
                      ...
                      <a href={job.companyInfo.website} target="_blank" rel="noopener noreferrer" className="text-[#f26b38] hover:underline">
                        Website
                      </a>
                    </div>
                    <div className="flex items-center text-sm text-gray-600">
                      <Mail className="h-4 w-4 mr-2 text-gray-400" />
                      <a href={`mailto:${job.companyInfo.email}`} className="text-[#f26b38] hover:underline">
